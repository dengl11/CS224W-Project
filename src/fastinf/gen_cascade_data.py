...
def output_cascades(cascades_dict,nodes_name):
	data = open("./data/terror_cascade_1996-2016_ME_cascades.txt", 'w+')
	nodes = open("./data/terror_cascade_1996-2016_ME_names.txt", 'w+')
	unknown = 0
...
def main():
	terror_data_list = modified_dataset(True)
